        ...
        <header className="flex sm:hidden flex-col gap-2.5 pb-6 border-b border-zinc-200 dark:border-zinc-800">
          ...
          <div className="px-1 flex items-center gap-2 w-full mt-1">
            ...
            <a 
              ...
              target="_blank"
              rel="noreferrer"
              className={`flex-1 py-1.5 text-xs font-sf font-semibold rounded-lg border transition-all duration-200 text-center inline-flex items-center justify-center ${
                theme === 'dark' 
                  ? 'bg-transparent border-zinc-800 hover:bg-zinc-900 text-white' 
                  : 'bg-transparent border-gray-150 hover:bg-gray-50 text-black'
              }`}
